...
Als eerste is in hoofdstuk 2 de conventionele binaire zoekboom behandeld. Hierna is gekeken naar gebalanceerde bomen, de AVL-boom (hoofdstuk 3) en de (2,4)-boom (hoofdstuk 4). Als laatste wordt in hoofdstuk 4 een alternatieve datastructuur behandeld, de skip list.
